    ...
    try:  		   	  			  	 		  		  		    	 		 		   		 		  
        ...
        if (group is "RTLearner") or (group is "DTLearner"):  		   	  			  	 		  		  		    	 		 		   		 		  
            ...
            def onebag():  		   	  			  	 		  		  		    	 		 		   		 		  
                ...
                learner1.add_eidence(trainX,trainY)
            ...
            def twentybags():  		   	  			  	 		  		  		    	 		 		   		 		  
                ...
                learner20.add_evidence(trainX,trainY)
            ...
            try:  		   	  			  	 		  		  		    	 		 		   		 		  
                ...
                if (len(accd)!=20) or (any([v!=1 for v in accd.values()])):  		   	  			  	 		  		  		    	 		 		   		 		  
                    incorrect = True  		   	  			  	 		  		  		    	 		 		   		 		  
                    msgs.append("    Unexpected number of calls to add_evidence sum={} (should be 20), max={} (should be 1), min={} (should be 1)".format(len(accd),max(accd.values()),min(accd.values())))
                    points_earned = -10  		   	  			  	 		  		  		    	 		 		   		 		  
...
def gen_class():  		   	  			  	 		  		  		    	 		 		   		 		  
    ...
    c_def+= "    def add_evidence(self,trainX,trainY):\n"
